...
FtpConnection.prototype._command_LIST = function (x) { this._LIST(x, true/*detailed*/); };
FtpConnection.prototype._command_NLST = function (x) { this._LIST(x, false/*!detailed*/); };
...
FtpConnection.prototype._STOR_usingWriteFile = function (filename) {
    ...
    function closeHandler () {
        ...
        self.fs.writeFile(PathModule.join(self.root, filename), slurpBuf, function (err) {
            self.emit("file:stor","close", {
                user: self.username, 
                file: filename,
                filesize: totalBytes,
